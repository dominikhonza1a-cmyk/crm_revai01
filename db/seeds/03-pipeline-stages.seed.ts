...
export const pipelineStageSeeds = [
  { name: "Lead", position: 1, kind: "open", probabilityDefault: 10, staleAfterDays: 14 },
  { name: "Qualified", position: 2, kind: "open", probabilityDefault: 25, staleAfterDays: 14 },
  { name: "Discovery", position: 3, kind: "open", probabilityDefault: 40, staleAfterDays: 21 },
  { name: "Proposal", position: 4, kind: "open", probabilityDefault: 60, staleAfterDays: 10 },
  { name: "Negotiation", position: 5, kind: "open", probabilityDefault: 80, staleAfterDays: 10 },
  { name: "Won", position: 6, kind: "won", probabilityDefault: 100, staleAfterDays: null },
  { name: "Lost", position: 7, kind: "lost", probabilityDefault: 0, staleAfterDays: null },
] as const;
